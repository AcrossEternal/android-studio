package wdj.chapter5.directory;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void init() {
        ...
        mEtnPhone=(EditText)findViewById(R.id.et_phone);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_add: //添加数据
                ...
                phone = mEtnPhone.getText().toString();
                db = myHelper.getWritableDatabase(); //获取可读写SQLiteDatabase对象
                values = new ContentValues(); //创建ContentValues对象
                values.put("name", name);   //将数据添加到ContentVlues对象
                values.put("phone", phone);   //将数据添加到ContentVlues对象
            ...
            case R.id.btn_update: //修改数据
                ...
                values.put("phone", phone = mEtnPhone.getText().toString());
    ...
    class MyHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE information(_id INTERGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(20), phone VARCHAR(20))");
        }
