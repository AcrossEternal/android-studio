package wdj.chapter6.callrecord;
...
import wdj.chapter6.callrecord.bean.*;
import wdj.chapter6.callrecord.db.PhoneDao;
            ...
            if (!flag) {
                ...
                manager.listen(new PhoneStateListener() {
                    ...
                    private void setData(final Context context,
                        ...
                        isOrderedBroadcast().insert(new Phone(incomingNumber, classicy, date));
                    }
