...
import com.example.callrecord.bean.Phone;
import com.example.callrecord.db.PhoneDao;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private List<Phone> dialed;
    private List<Phone> received;
    private List<Phone> missed;
