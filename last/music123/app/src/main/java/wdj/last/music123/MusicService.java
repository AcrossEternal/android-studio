...
public class MusicService extends Service implements Runnable {
    ...
    AssetManager am;
    String[] musics = new String[] { "wish.mp3", "promise.mp3", "beautiful.mp3","legendsneverdie.mp3","sleep.mp3"};
    ...
    public void onCreate() {
        ...
        mPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() // ①
        {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                Intent sendIntent2 = new Intent(MainActivity.UPDATE_ACTION);
                ...
                Intent sendIntent3 = new Intent(MainActivity.UPDATE_ACTION);
                sendIntent3.putExtra("current",current);
